				...
				<ul class="nav" id="side-menu">
					...
					<li><a href="#"><i class="fa fa-github"></i> 参加竞赛管理 <span class="fa arrow"></span></a>
						<ul class="nav nav-third-level">
							...
							<li><a class="J_menuItem" href="game.action?cmd=getAllGame">竞赛列表</a></li>
					...
					<li><a href="#"><i class="fa fa-commenting-o"></i> 评论管理 <span class="fa arrow"></span></a>
						...
						<ul class="nav nav-second-level">
							<li><a class="J_menuItem" href=user.action?cmd=findPageUser&currPage=1&pageSize=10 data-index="0"><i class="fa fa-user"></i>完善个人信息</a></li>
							<li><a class="J_menuItem" href="view/user/useradd.jsp" data-index="0"><i class="fa fa-user-plus"></i>修改密码</a></li>
						</ul></li>
				</ul>
			</div>
		</nav>
