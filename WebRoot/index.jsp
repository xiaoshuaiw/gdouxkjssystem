F<%@ page language="java" import="java.util.*" pageEncoding="UTF-8" isELIgnored="false"%>
<%
	...
	<div id="wrapper">
				...
				<ul class="nav" id="side-menu">
					<li class="nav-header">
						<div class="dropdown profile-element">
							...
							<strong class="font-bold">${user.realName}</strong></span> 
					...
					<li><a href="#"> <i class="fa fa-cogs"></i> <span class="nav-label">首页管理</span> <span class="fa arrow"></span></a>
						<ul class="nav nav-second-level">
							<li><a class="J_menuItem" href="welcome.jsp" data-index="0"><i class="fa fa-user-plus"></i>通知公告</a></li>
						</ul></li>

					<li><a href="#"><i class="fa fa-github"></i> 学科竞赛管理 <span class="fa arrow"></span></a>
						<ul class="nav nav-third-level">
							<li><a class="J_menuItem" href="view/game/gameadd.jsp">发布竞赛活动</a></li>
							<li><a class="J_menuItem" href="game.action?cmd=findPageGame&currPage=1&pageSize=10">竞赛设置</a></li>
							<li><a class="J_menuItem" href="game.action?cmd=findtype">竞赛分类</a></li>
						</ul></li>
					<li><a href="#"><i class="fa fa-github"></i> 参加竞赛管理 <span class="fa arrow"></span></a>
						<ul class="nav nav-third-level">
							<li><a class="J_menuItem" href="upload.jsp">上传文件</a></li>
							<li><a class="J_menuItem" href="download.jsp">下载表格</a></li>
							<li><a class="J_menuItem" href="game.action?cmd=findPageGame&currPage=1&pageSize=10">竞赛详情</a></li>
							<li><a class="J_menuItem" href="view/competition/competitionadd.jsp">报名资料上传</a></li>
							<li><a class="J_menuItem" href="competition.action?cmd=findPageCompetition&currPage=1&pageSize=10" data-index="0">查看参赛详情</a></li>
						</ul></li>
					<li><a href="#"><i class="fa fa-commenting-o"></i> 评论管理 <span class="fa arrow"></span></a>
						<ul class="nav nav-third-level">
							<li><a class="J_menuItem" href="view/comment/commentadd.jsp">发表评论</a></li>
							<li><a class="J_menuItem" href="comment.action?cmd=findPageComment&currPage=1&pageSize=10">评论设置</a></li>
							<li><a class="J_menuItem" href=comment.action?cmd=findPageReply&currPage=1&pageSize=10">回复设置</a></li>
						</ul></li>
						<li><a href="#"> <i class="fa fa-user"></i> <span class="nav-label">用户设置</span> <span class="fa arrow"></span></a>
						<ul class="nav nav-second-level">
							<li><a class="J_menuItem" href=user.action?cmd=findPageUser&currPage=1&pageSize=10 data-index="0"><i class="fa fa-user"></i>已注册师生详情</a></li>
							<li><a class="J_menuItem" href="view/user/useradd.jsp" data-index="0"><i class="fa fa-user-plus"></i>用户添加</a></li>
							<li><a class="J_menuItem" href="view/user/userrate.jsp" data-index="0"><i class="fa fa-user-plus"></i>已注册师生比例</a></li>
						</ul></li>
						<li><a href="#"><i class="fa fa-github"></i> 联系我们 <span class="fa arrow"></span></a>
						<ul class="nav nav-third-level">
							<li><a class="J_menuItem" href="view/game/author.jsp">作者信息以及版权</a></li>
						</ul></li>
				</ul>
			</div>
		</nav>
		...
		<div id="page-wrapper" class="gray-bg dashbard-1">
			...
			<div class="row content-tabs">
				...
				<a href="user.action?cmd=logout" class="roll-nav roll-right J_tabExit"><i class="fa fa fa-sign-out"></i> 退出</a>
			</div>
			<div class="row J_mainContent" id="content-main">
				<iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="welcome.jsp" frameborder="0" data-id="index_v1.html" seamless></iframe>
			</div>
			<div class="footer">
				<div class="pull-right">
					&copy; 2018-2019 <a href="http://www.zi-han.net/" target="_blank">本网站归属于李升，李钦平</a>
				</div>
			</div>
		</div>
		<!--右侧部分结束-->
					...
					<div id="tab-1" class="tab-pane active">
						...
						<div class="skin-setttings">
							...
							<div class="setings-item default-skin nb">
								<span class="skin-name "> <a href="#" class="s-skin-1"> 默认皮肤 </a>
								</span>
							</div>
						</div>
					</div>
